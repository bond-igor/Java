...
public class certification_task {
    public static void main(String[] args) {
        Notebook notebook1 = new Notebook("Asus", "4", "512", "Windows", "grey");
        Notebook notebook2 = new Notebook("Asus", "4", "256", "Linux", "black");
        Notebook notebook3 = new Notebook("Hp", "32", "2000", "Windows", "black");
        Notebook notebook4 = new Notebook("Asus", "16", "1000", "Windows", "grey");
        Notebook notebook5 = new Notebook("Huawei", "8", "1000", "MacOsy", "black");
    ...
    public static Map<String, String> selectCriteria() {
        ...
        while (true) {
            System.out.println("Ввести критерий сортировки y/n ?");
